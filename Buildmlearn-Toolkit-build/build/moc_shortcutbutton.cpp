...
#include "../../src/dynamic-shortcuts/shortcutbutton.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_ShortcutButton_t, stringdata) + ofs \
...
const QMetaObject ShortcutButton::staticMetaObject = {
    { &QPushButton::staticMetaObject, qt_meta_stringdata_ShortcutButton.data,
      qt_meta_data_ShortcutButton,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *ShortcutButton::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ShortcutButton.stringdata))
        return static_cast<void*>(const_cast< ShortcutButton*>(this));
